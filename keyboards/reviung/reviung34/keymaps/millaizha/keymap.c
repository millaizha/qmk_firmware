...
[WINMISC] = LAYOUT_reviung34(
    ...
    //|--------------+--------------+--------------+--------------+--------------|                    |--------------+--------------+--------------+--------------+--------------|
         LGUI(KC_E),    LGUI(KC_I),    LGUI(KC_L),    RCS(KC_S),     LGUI(KC_V),                           KC_BRID,      KC_WH_L,       KC_WH_D,       KC_WH_U,       KC_WH_R,  
    //`--------------+--------------+--------------+--------------+--------------'                    `--------------+--------------+--------------+--------------+--------------'
...
[WINGAME] = LAYOUT_reviung34(
    //,--------------------------------------------------------------------------.                    ,--------------------------------------------------------------------------.
            KC_TAB,        KC_Q,          KC_W,         KC_E,           KC_R,                               KC_T,         KC_Y,          KC_U,          KC_I,          KC_O, 
    //|--------------+--------------+--------------+--------------+--------------|                    |--------------+--------------+--------------+--------------+--------------|
            KC_LSFT,       KC_A,          KC_S,         KC_D,           KC_F,                               KC_G,         KC_H,          KC_J,          KC_K,          KC_L,  
    //|--------------+--------------+--------------+--------------+--------------|                    |--------------+--------------+--------------+--------------+--------------|
            KC_LCTL,       KC_Z,          KC_X,         KC_C,           KC_V,                               KC_B,         KC_N,          KC_M,          KC_P,         TD(CLMK),  
    //`--------------+--------------+--------------+--------------+--------------'                    `--------------+--------------+--------------+--------------+--------------'
                                                       KC_SPC,        TD(CLMK),                             KC_1,         KC_2 
                                                 //`--------------+--------------'                    `--------------+--------------'
    )
};
