...
[COLEMAK] = LAYOUT_reviung34(TD(COPY_Q), KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_QUOT, LGUI_T(KC_A), LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), KC_G, KC_M, RSFT_T(KC_N), RCTL_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O), TD(UNDO_Z), TD(CUT_X), KC_C, KC_D, TD(PASTE_V), KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, LT(1,KC_BSPC), KC_TAB, KC_ENT, LT(2,KC_SPC)),
